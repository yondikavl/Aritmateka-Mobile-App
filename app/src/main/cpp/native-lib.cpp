...
Java_com_yondikavl_aritmateka_util_SecurityManger_00024Keys_Secretkey(JNIEnv *env,
                                                                         jobject thiz) {
    return env ->NewStringUTF("750GdiCY1GWXzRjH2W9esuGDGAzNNvbVbxfAAAN65mt5WrZwlz49KgpYzFhLQejd");
}
extern "C"
JNIEXPORT jstring JNICALL
Java_com_yondikavl_aritmateka_util_SecurityManger_00024Keys_ALGORITHM(JNIEnv *env,
                                                                         jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_yondikavl_aritmateka_util_SecurityManger_00024Keys_TRANSFORMATION(JNIEnv *env,
                                                                              jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_yondikavl_aritmateka_util_SecurityManger_00024Keys_KEYPASSWORD(JNIEnv *env,
                                                                           jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_yondikavl_aritmateka_util_SecurityManger_00024Keys_IVPASSWORD(JNIEnv *env,
                                                                          jobject thiz) {
